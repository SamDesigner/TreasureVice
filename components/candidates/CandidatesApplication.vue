<template>
    <div class="bg-grayBg py-[80px] px-[16px] md:px-[80px] flex justify-center text-darkGreen">
       <div class="max-w-[1280px] flex  flex-col gap-[40px]">
            <div>
                <h1 class="text-center text-[32px] font-[600] leading-[48px]">Submit Your Application</h1>

<template>
    <div class="bg-white py-[40px] md:py-[80px] px-[16px]">
        <div class="max-w-[1240px] mx-auto grid grid-cols-1   gap-[60px]">
            <div 
            data-aos="fade-right"
            class="flex flex-col gap-[40px] lg:w-[740px] ">
                <div class="flex flex-1 h-fit flex-col gap-[8px]">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-[40px]">
                ...
                class="lg:w-[373px]  py-[24px] px-[16px] flex flex-col justify-center gap-[10px] h-[280px] card_bg rounded-[8px] border-darkGreen ">
                    <h1 class="text-[20px] text-darkGreen lg:text-[24px] font-[600] leading-[36px]  text-center  ">We listen</h1>
                ...
                data-aos="flip-up"
                class="lg:w-[373px]  py-[24px] px-[16px] flex flex-col justify-center gap-[10px] h-[280px] card_bg rounded-[8px] border-darkGreen ">
                    <h1 class="text-[20px] text-darkGreen lg:text-[24px] font-[600] leading-[36px]  text-center ">We Communicate</h1>
                    <div class="flex justify-center">
                         <div class="border-b border-primary w-[102px]" ></div>
                    </div>
                ...
                data-aos="flip-up"
                class="lg:w-[373px]  py-[24px] px-[16px] flex flex-col justify-center gap-[10px] h-[280px] card_bg rounded-[8px] border-darkGreen ">
                    <h1 class="text-[20px] text-darkGreen lg:text-[24px] font-[600] leading-[36px]  text-center ">Adaptable and Flexible</h1>
                    <div class="flex justify-center">
                         <div class="border-b border-primary w-[102px]" ></div>
                    </div>
                    ...
                    <div>
                        ...
                        <p class="text-darkGreen text-[16px] md:text-[18px] font-[400] leading-[28px] text-center">
                            Whether you need our services for a short- or long-term placement, you will receive the best care service that meets all your needs.
                        </p>    
                    </div>
                ...
                data-aos="flip-up"
                class="lg:w-[373px]  py-[24px] px-[16px] flex flex-col justify-center gap-[10px] h-[280px] card_bg rounded-[8px] border-darkGreen ">
                    <h1 class="text-[20px] text-darkGreen lg:text-[24px] font-[600] leading-[36px] text-center ">We’re all about Personal</h1>
                    <div class="flex justify-center">
                         <div class="border-b border-primary w-[102px]" ></div>
                    </div>
                ...
                class="grid md:col-span-2 lg:col-span-3 card_bg  flex justify-center rounded-[8px] ">
                    ...
                    data-aos="flip-up"
                    data-aos-delay="400"
                    class="lg:w-[552px]  py-[24px] px-[16px] flex flex-col justify-center gap-[10px] h-[280px] border-darkGreen   ">
                        <h1 class="text-[20px] text-darkGreen lg:text-[24px] font-[600] leading-[36px] text-center ">Genuinely Cares</h1>
                        <div class="flex justify-center">
                            <div class="border-b border-primary w-[102px]" ></div>
                        </div>
                        ...
                        <div>
                            ...
                            <p class="text-darkGreen text-[18px] md:text-[18px] font-[400] leading-[28px] text-center">
                                Our carers are caring, fully trained, vetted and experienced, they follow a pathway of ongoing personal development through training, appraisal and a reward-based system.
                            </p>
                        </div>
